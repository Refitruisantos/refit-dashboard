              ...
              <div>
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  <button
                    ...
                    onClick={() => setFormData({
                      name: 'Pilates 1x',
                      description: 'Aula de Pilates 1x por semana',
                      price: 30,
                      duration: 60,
                      billingType: 'monthly',
                      active: true,
                    })}
                    className="rounded-lg border border-border bg-muted/50 px-3 py-2 text-sm text-left transition-all hover:border-primary hover:bg-primary/10"
                  >
                    <span className="font-medium">🧘 Pilates 1x</span>
                    <span className="block text-xs text-muted-foreground">Mensal • €30 • 60min</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => setFormData({
                      name: 'Pilates 2x',
                      description: 'Aula de Pilates 2x por semana',
                      price: 50,
                      duration: 60,
                      billingType: 'monthly',
                      active: true,
                    ...
                    className="rounded-lg border border-border bg-muted/50 px-3 py-2 text-sm text-left transition-all hover:border-primary hover:bg-primary/10"
                  >
                    <span className="font-medium">🧘 Pilates 2x</span>
                    <span className="block text-xs text-muted-foreground">Mensal • €50 • 60min</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => setFormData({
                      name: 'Hybrid 2x',
                      description: 'Treino híbrido 2x por semana',
                      price: 35,
                      duration: 60,
                      billingType: 'monthly',
                      active: true,
                    ...
                    className="rounded-lg border border-border bg-muted/50 px-3 py-2 text-sm text-left transition-all hover:border-primary hover:bg-primary/10"
                  >
                    <span className="font-medium">💪 Hybrid 2x</span>
                    <span className="block text-xs text-muted-foreground">Mensal • €35 • 60min</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => setFormData({
                      name: 'Treino Personalizado',
                      description: 'Personal Training 1-1',
                      price: 15,
                      duration: 60,
                  ...
                  >
                    ...
                    <span className="block text-xs text-muted-foreground">Por Sessão • €15 • 60min</span>
                  </button>
                </div>
              </div>
            )}
